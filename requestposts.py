...
def run_request(scheduler):
    ...
    if r.status_code != 200:
        ...
        print("Error details: " + data['error_name'] + " " + str(data['error_id']))
        print(data['error_message'])
    quota = data['quota_remaining']
    print('Quota remaining ' + str(quota))
    ...
    if quota <= 10:
        print('!! LOW QUOTA, BACKING OFF FOR 2 HOURS !!')
    ...
    if backoff >= 900:
        print('BACKOFF RECEIVED OF ' + str(backoff) + ' seconds')
